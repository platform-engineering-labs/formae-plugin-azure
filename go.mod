module github.com/platform-engineering-labs/formae-plugin-azure
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/resources/armpolicy/v2 v2.0.0-beta.2
